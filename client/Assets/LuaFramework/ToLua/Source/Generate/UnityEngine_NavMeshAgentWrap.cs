...
public class UnityEngine_NavMeshAgentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityEngine_NavMeshAgent);
	...
	static int _CreateUnityEngine_NavMeshAgent(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.NavMeshAgent.New");
			}
		}
		catch(Exception e)
		{
