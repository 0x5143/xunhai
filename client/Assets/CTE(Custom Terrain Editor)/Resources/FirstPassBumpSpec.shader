...
Shader "Hidden/CTE/FirstPass Bumped Specular" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf BlinnPhong vertex:Vert finalcolor:myfinal exclude_path:prepass exclude_path:deferred
